...
| `/app/home · advisor · workflows · cases · employees · compliance · policies · templates · tasks · calendar · analytics · knowledge · communications · compensation · wellbeing · settings` | The 16 views (`/app/reports` redirects to `/app/analytics` — the destination has one name everywhere)                                                                  |
