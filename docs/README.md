...
| [SCORING_LOGIC.md](SCORING_LOGIC.md)                                           | Where every number comes from: the compliance score in demo and production, flow scoring, Advisor risk/confidence, the Analytics aggregation rules — and the proposed score v2.     |
