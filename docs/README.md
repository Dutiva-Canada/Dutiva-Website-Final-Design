...
| [SCORING_LOGIC.md](SCORING_LOGIC.md)                                           | How every score is computed: the compliance score (formula v2 — severity-weighted, critical-capped, versioned), flow scoring, Advisor risk/confidence, Analytics aggregation rules. |
