...
export const employees: Employee[] = [
  ...
  },
  {
    ...
    name: 'Priya Nair',
    initials: 'PN',
    role: bi('Senior Analyst', 'Analyste principal'),
    ...
    insight: bi(
      'Priya accepted her offer. Probation runs to the 3-month mark — I’ll remind you before it ends.',
      'Priya a accepté son offre. La probation court jusqu’à 3 mois — je vous le rappellerai avant la fin.',
    ),
    risk: null,
  },
  {
  ...
  },
  {
    ...
    name: 'Amara Okafor',
    initials: 'AO',
    role: bi('Software Engineer', 'Ingénieur logiciel'),
    dept: bi('Engineering', 'Ingénierie'),
    province: bi('British Columbia', 'Colombie-Britannique'),
    status: bi('On Leave', 'En congé'),
    tone: 'warning',
  ...
  },
  {
    ...
    name: 'Grace Osei',
    initials: 'GO',
    role: bi('Financial Analyst', 'Analyste financier'),
    // The prototype's deptFor() routes "Financial Analyst" to Engineering
    // (analyst + financial branch) — transcribed faithfully.
    dept: bi('Engineering', 'Ingénierie'),
    province: bi('Alberta', 'Alberta'),
    status: bi('Active', 'Actif'),
    tone: 'warning',
...
export const compEquityCard = {
  title: bi(
    'Potential internal equity issue — review recommended',
    'Enjeu potentiel d’équité interne — examen recommandé',
  ),
  body: bi(
    'Théo Lavoie’s base has tracked about 10% below the market midpoint for a comparable role. Dutiva cannot determine pay-equity compliance conclusively — additional comparator data and HR/Finance review are required, and legal/pay-equity review may be required if a gap is confirmed.',
    'Le salaire de base de Théo Lavoie se situe à environ 10 % sous le point milieu du marché pour un poste comparable. Dutiva ne peut pas déterminer de façon concluante la conformité en équité salariale — des données comparatives supplémentaires et un examen RH/Finances sont requis, et une révision juridique ou d’équité salariale peut être nécessaire si un écart est confirmé.',
  ),
}
...
export const supportSignals: SupportSignal[] = [
  ...
  },
  {
    ...
    confidence: bi('Medium', 'Moyenne'),
    why: bi(
      'Attendance conversations are underway; a support dimension may exist. Support resources must be offered separately from the performance process.',
      'Des conversations sur l’assiduité sont en cours; une dimension de soutien peut exister. Les ressources de soutien doivent être offertes séparément du processus de rendement.',
    ),
    action: bi(
  ...
  },
  {
    ...
    why: bi(
      ...
      'Les tâches ouvertes se concentrent sur deux personnes pendant que le dossier de cessation est actif.',
    ),
    action: bi(
