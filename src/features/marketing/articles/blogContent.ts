...
/**
 * Section bodies for `/blog`, keyed by the article's English slug.
 *
 * Split from the metadata in blogArticles.ts so the prose is not in the eager
