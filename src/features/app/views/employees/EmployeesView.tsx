...
export function EmployeesView() {
  ...
  /* Prototype filter: case-insensitive substring on name, role, or province.
     It matches its EN state strings; here we match the active language so FR
     users can filter on FR roles/provinces (same approach as global search). */
